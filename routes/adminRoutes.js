...
const {viewAdminProfile, viewUserProfile, viewAllUsers, viewAllSellers, viewPendingProducts, viewAllProducts, updateProductStatus, pendingSellers, approveSeller} = require('../controllers/adminController');
